...
_“You do not speak for them,”_ she says.
...
> **_Firsthood_** is temporary, claim-specific power over a durable path that later participants cannot yet answer. It belongs to whoever can presently open or close that path.
...
She cannot take the surface worker’s home, wages, water, or medical care and announce that hypothetical future people _needed the sacrifice_.
...
Offices end. Models lose. Contracts dissolve. Standards fork. Categories fail. A constitution _persists_ through the conditions that allow successors to become authors of what replaces them.
