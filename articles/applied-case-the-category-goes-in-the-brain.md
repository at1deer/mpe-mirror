...
A new paper in _Frontiers in Psychiatry_ examines the “aberrant network topology of cortical-subcortical circuits in schizophrenia and bipolar disorder.”
...
Because _this_ experiment can now tell us whether populations selected using _those_ categories differ along the measurements being taken.
...
## **What the _Fuck_ Are We Measuring?**
...
This is _science_. This is _also_ why the sentence “_the brain scan shows schizophrenia_” should make your hand move toward the emergency brake and mouth make a noise like **_“oeuea”._**

Because, oh man, oh God, just fucking _look_ at everything that just happened between
...
There are findings apparently more _specific to_ schizophrenia.
...
But then, we enter the _Discussion_ section.
...
**So why the hell are we driving the _Discussion_ section across it?**

You can propose mechanisms. Please, propose mechanisms. That is part of what _Discussion_ sections are for.

But speculation has to remain visibly downstream of evidence.

“_Could contribute to_” is not the same state as “_was associated with in this study._”

The paper does know that. The language occasionally tries to forget.

* * *

## **But Why Am I Yelling at _You_?**
...
So what the hell am I yelling at _you_ for?
...
The _problem_ is larger. These very good researchers are working [inside a field](https://modalpathethics.com/popular-mechanics-has-gone-mad-with-power/) whose ordinary grammar makes a very particular little move feel natural:

1.  Begin with _schizophrenia_.
2.  Begin with _bipolar disorder_.
3.  Compare their brains.
4.  Find different distributions of some measurements.
5.  Call the measurements _abnormalities of schizophrenia and bipolar disorder_.
6.  Ask whether those abnormalities can become biomarkers of the disorders with which the populations were selected.

And there is valuable research hidden inside that pipeline.

There is also a _category_ trying **very hard** to become an _ontology_.
...
The conditional matters. They say **_could_**.
...
There is no diagnostic classifier here that receives an unknown patient and reliably returns _schizophrenia_ or _bipolar disorder_.
...
_Candidate signal_. _Research program_. _Interesting result_. **_Keep going_**.
...
None of this requires anyone to declare _schizophrenia_ imaginary, **Thomas**.
...
![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/icon/thin-tile.rulebook-2-12a416b1-c9c3-427d-ae1c-76aed4adbdef.png)Modal Path EthicsAidan Lawson

![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/thumbnail/hq720-1-a78270e3-afaa-45e1-b30c-4eee57900e7b.jpg)

](https://modalpathethics.com/failed-field-analysts-thomas-szasz-and-the-myth-machine/)
...
A category becomes dangerous when successful coordination gets promoted into ownership of _the thing being coordinated_.
