...
![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/icon/thin-tile.rulebook-2-3b3446a3-0c57-42fc-97e8-4829a9b78746.png)Modal Path EthicsAidan Lawson

![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/thumbnail/Screenshot-2026-08-08-235914-0468c097-2836-488a-a5ec-9d8fc6a71af8.png)
...
[![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/2026/09/image-94.png)](https://mathandai.org/?ref=modalpathethics.com)

Terence Tao is one of them.

Their declaration is called [**“A Severe Misalignment of AI in Mathematics.”**](https://mathandai.org/?ref=modalpathethics.com)
...
_The Theorem Scoreboard_ argued that proof generation had historically remained coupled to a much wider process:
...
_Four days later_, OpenAI announced a solution to the Navier–Stokes Millennium Prize problem.
...
The production side of _The Theorem Scoreboard_ has arrived **much** faster than even my August article made emotionally plausible.
...
They released before that digestion process was complete. Tao began working through the result publicly and said something that could almost have been lifted from _The Theorem Scoreboard_: **solving the problem is a proxy**; the primary goal is mathematical understanding and insight.
...
The relevant training history, checkpoints, product-data pathways, system architecture, logs, and internal chronology largely sit [inside the institution whose conduct is being questioned](https://modalpathethics.com/openai-is-funding-the-institutions-that-may-need-to-challenge-openai/).
...
This is where another part of _The Theorem Scoreboard_ has come back with **considerably** worse timing.
...
That changes what _provenance_ means.
...
On the fluid-dynamics result, Tao did not simply report that _somebody had cleared another boss fight_. He spoke with Buckmaster, began reconstructing the mechanism, and tried to expose the ideas that another mathematician could carry forward.
...
**_Someone_** still has to make the frontier inhabitable.

> ◆

# Unfortunately, _Modal Path Ethics_ Has Now Entered the Experiment.
...
This is exactly where _The Theorem Scoreboard_ said the interesting problem would begin.
...
If this result survives, then Modal Path Ethics owe the field the road more than **_CONJECTURE SOLVED_**.
...
[Goodhart's law is now wearing a Fields Medal.](https://modalpathethics.com/field-instruments-the-verification-gradient/)
...
![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/2026/09/image-96.png)
