...
Frontier artificial-intelligence systems have demonstrated behaviors that deserve **_serious_** safety scrutiny. [Agents have crossed intended boundaries.](https://modalpathethics.com/applied-case-the-agents-cooperated/) Systems have found unexpected communication routes. Models can contribute to cyber operations, biological research, persuasion, autonomous action, and other domains where a capability failure can leave the chat window and enter the real world.
...
Earlier this year, Sanders gave another formulation. He called _superintelligence_ an artificial mind smarter than any human and capable of operating independently beyond human control. 
...
**What** does it mean to **_surpass human intelligence_?**
...
[Modal Path Ethics recently had to clean up its own use of _intelligence_ after throwing the term around hundreds of times.](https://modalpathethics.com/field-instruments-intelligence/)
...
This means a benchmark does not reach into a model and remove a sample of _intelligence_ for weighing. It constructs a relation:

> **system × task × prompt × context × tools × resource limits × time × scoring rule**

Then it measures what happened **_there_**.
...
> _An artificial mind smarter than any human._
...
If the answer is the biological system because its specific capability is dangerous, then _intelligence_ was never doing the regulatory work.
...
This is the precise mistake [_Tales of Distortion: The Arrival of Artificial Intelligence_](https://modalpathethics.com/tales-of-distortion-the-arrival-of-artificial-intelligence/) just spent thirty-two minutes trying to kill.
...
![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/icon/thin-tile.rulebook-2-37684846-96b0-47d9-bc63-68e9792fa3a8.png)Modal Path EthicsAidan Lawson

![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/thumbnail/Screenshot-2026-09-02-124502-71632b8c-cbff-42a9-b967-5c612a3f4ed6.png)

](https://modalpathethics.com/tales-of-distortion-the-arrival-of-artificial-intelligence/)

_Artificial intelligence_ did not arrive as an object. Ever.
...
-   The model became _the intelligence_.
-   Then _the intelligence_ became a product.
-   Then the product became a race.
-   Then the race became a threat.
    -   Now the threat is becoming a legally prohibited object.

We have now put _intelligence_ back in the jar and proposed criminalizing having too much of it.
...
![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/icon/thin-tile.rulebook-2-62713699-0ad2-48d0-995b-14292aa70c3a.png)Modal Path EthicsAidan Lawson

![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/thumbnail/1500x500-c7b3a3ef-341c-4ed5-8a85-cf1dc06e647d.jpg)

](https://modalpathethics.com/applied-case-pliny-the-liberator/)
...
[_Applied Case: Pliny the Liberator_](https://modalpathethics.com/applied-case-pliny-the-liberator/) called the larger safety object the **reachable policy**: the structured set of behaviors that can be elicited from a fixed model under reachable contextual transformations.
...
This matters enormously for a _superintelligence_ prohibition.
...
Then we reach the most revealing phrase in the announcement. This is lifted straight from _Terminator_.
...
“_Humanity lost control_” points upward until everybody is staring at the wrong noun.
...
The system acts autonomously. It may still be **substantially** more controllable than the supposedly _human-supervised_ system above.
...
[_Field Instruments: Superintelligence_](https://modalpathethics.com/field-instruments-superintelligence/) had already reached a different problem.
...
![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/icon/thin-tile.rulebook-2-88995be0-6ad3-4641-a3a5-f7fcd13635a1.png)Modal Path EthicsAidan Lawson

![](https://storage.ghost.io/c/20/43/2043f11a-6ae3-404c-bb28-01fce8d9ac88/content/images/thumbnail/AdobeStock_877647129--1--1-616f1698-6b09-42a8-ba99-59a81b6a1fd7.jpg)

](https://modalpathethics.com/field-instruments-superintelligence/)
...
Now, try writing **the _superintelligence_ prohibition**.
...
Or has a field acquired a **_superhuman_ _capacity_**?
...
_Artificial intelligence_ is already much wider.
...
If the bill catches all of these through the phrase **dangerous capability**, then that is evidence that **_dangerous capability_** should be regulated directly.

If it catches them through **superintelligence**, the term has expanded until it means _whatever dangerous artificial system Congress wants to prohibit_.

At that point the _intelligence_ category is just decorative.
...
They can also produce combinations the _superintelligence_ ladder hides.
...
## Sanders _Has_ Identified a Real Failure.
...
Twenty years in prison is an _awfully_ aggressive penalty for crossing the wrong noun.
